  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="my-8">
        ...
        <h4>
          <strong>MERN Stack Development:</strong> Proficient in using MongoDB,
          Express.js, React.js, and Node.js to develop full-stack web
          applications.
        </h4>
        <h4>
          <strong>Front-End Development:</strong> Skilled in creating responsive
          and dynamic user interfaces using React.js, Redux, JavaScript, HTML,
          and CSS.
        </h4>
        <h4>
          <strong>Back-End Development:</strong> Experienced in building RESTful
          APIs, handling authentication, and managing databases with Node.js and
          Express.js.
        </h4>
        <h4>
          <strong>Database Management:</strong> Strong understanding of MongoDB,
          Mongoose, and data modeling for efficient database design and
          querying.
        </h4>
        <h4>
          <strong> Version Control:</strong> Proficient in using Git for version
          control, branching, and merging code changes in collaborative
          projects.
        </h4>
      </div>
      <div className="my-8">
      ...
      <div className="my-8">
        ...
        <h4>
          <strong>Reading:</strong> I enjoy reading books on tech, business, and
          self-improvement.
        </h4>
        <h4>
